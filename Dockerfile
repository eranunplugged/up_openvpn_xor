...
# Versions (UNP-8203): OpenVPN 2.6.14 built from source with the Tunnelblick
# XOR/scramble patch (latest OpenVPN with a released Tunnelblick xorpatch,
# via Tunnelblick 8.0.2); EasyRSA baked in (OpenSSL 3 compatible).
...
# EasyRSA is baked into the image (UNP-8203) — scripts use $EASYRSA_DIR, no runtime download
